...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: SITE_NAME,
    description: SITE_DESC,
    // twitter:image is generated by src/app/opengraph-image.tsx
  },
  icons: {
    icon: '/favicon.ico',
  ...
  return (
    ...
    >
      ...
      <body>
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[999] focus:bg-ink focus:text-paper focus:px-5 focus:py-2.5 focus:font-body focus:text-sm focus:tracking-wide focus:outline-none focus:shadow-lg"
        >
          Skip to content
        </a>
